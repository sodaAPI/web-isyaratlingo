...
describe("Retrieving list of templated files", function () {
  it("should return 6 templatedFiles for a simple document", function () {
    ...
    expect(templatedFiles.sort()).to.be.eql(["docProps/app.xml", "docProps/core.xml", "word/document.xml", "word/footer1.xml", "word/footnotes.xml", "word/header1.xml", "word/settings.xml"]);
  });
});
describe("Api versioning", function () {
  ...
  it("should fail with invalid versions", function () {
    ...
    expectToThrow(doc.verifyApiVersion.bind(null, "3.35.100"), Errors.XTAPIVersionError, {
